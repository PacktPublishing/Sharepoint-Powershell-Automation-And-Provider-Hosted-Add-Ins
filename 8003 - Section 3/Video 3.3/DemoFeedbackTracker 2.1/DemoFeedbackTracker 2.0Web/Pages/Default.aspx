<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DemoFeedbackTracker_2._0Web.Default" %>
        ...
        $(document).ready(function () {
            ...
            $.getScript(scriptbase + "SP.UI.Controls.js", function () {
                var chromeSettings = {
                    ...
                    "appTitle": "Demo Feedback Tracker 2.0 (provider-hosted)",
                    "settingsLinks": [
                        {
